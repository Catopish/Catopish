...
## 📁 `:Telescope find_files` - Recent Projects
...
Check out my complete configuration: **[🔗 dotfiles/lazyvim](https://github.com/Catopish/lazyvim.git)**

## 🐧 `:!uname -a` - Linux Journey
...
│                                                     │
│  :wq to save and exit, or :q! if you want to       │
│  discard changes and explore other repos 😉        │
│                                                     │
╰─────────────────────────────────────────────────────╯
```
